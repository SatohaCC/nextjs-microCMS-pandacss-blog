describe('Pagination Component', () => {
    ...
    //         render(<Pagination totalCount={totalCount} category={category} currentPage={1} />);
    ...
    //         const currentPage = 3;
    //         render(
    //             <Pagination totalCount={totalCount} category={category} currentPage={currentPage} />
    //         );
    ...
    //                 expect(pageButton).not.toHaveClass('bg_accent.default text_accent.fg');
    //             }
    //         }
    //     });
